...
\usepackage{listings}
\setbeamercolor{sidebar}{use=structure,bg=red!90}
\lstset{language=SQL}
...
\frame{
    \frametitle{What does Jitterbug look like? (4)}
    \begin{center}
...
\frame{
    ...
    \begin{itemize}
        ...
        \item cd jitterbug
        \item perl Build.PL
        \item cpanm --installdeps . \# cpanminus to install deps
        \item OR
        \item ./Build installdeps \# install deps
...
\frame{
    ...
    \begin{center}
        \begin{itemize}
           ...
           \item dukeleto on irc.perl.org and Freenode
        \end{itemize}
    \end{center}
}
\end{document}
